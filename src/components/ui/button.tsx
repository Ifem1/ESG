...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-primary text-[#0a0f0d] hover:bg-primary/90 font-semibold',
        destructive:
          'bg-risk-critical text-white hover:bg-risk-critical/90',
        outline:
          'border border-[#1e2d22] bg-transparent text-text-primary hover:bg-surface hover:text-text-primary',
        secondary:
          'bg-surface text-text-primary hover:bg-card border border-[#1e2d22]',
        ghost:
          'hover:bg-surface hover:text-text-primary text-text-secondary',
        link: 'text-primary underline-offset-4 hover:underline',
        warning:
          'bg-risk-medium text-[#0a0f0d] hover:bg-risk-medium/90 font-semibold',
      },
      size: {
